...
//        var peliculaCine = intent.getSerializableExtra("cine") as Cine

        var cine = findViewById<TextView>(R.id.tvpelicula)
        var nombre = ECine.nombre
        cine.setText(nombre)
        val id = ECine.id_a
            ...
            R.id.eliminar_pelicula -> {
                ...
                AlertDialog.Builder(this).apply {
                    ...
                    setPositiveButton("Si"){ _: DialogInterface,_: Int ->
                        val db = Firebase.firestore
                        val id_cine = ECine.id_a
                        db.collection("cine").document(id_cine).collection("pelicula")
